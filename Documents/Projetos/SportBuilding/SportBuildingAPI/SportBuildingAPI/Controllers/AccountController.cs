...
using SportBuildingAPI.Providers;
using SportBuildingAPI.Results;
using static SportBuildingAPI.ApplicationUserManager;
         ...
         public ApplicationRoleManager RoleManager
    {
        ...
        public async Task<IHttpActionResult> Register(RegisterBindingModel model)
        {
           ...
           //atribuir roles aos usuarios
            ...
            {
                UserManager.AddToRole(user.Id, "Profissional");
            }
            else
            {
                UserManager.AddToRole(user.Id, "Condomino");
            }
