...
export class DuallistboxComponent implements OnInit {
  ...
  @Input() nonSelectedListLabel: string = 'Disponíveis';
  @Input() selectedListLabel: string = 'Selecionados';
  @Input() preserveSelectionOnMove: string = 'moved';
  @Input() moveOnSelect: boolean = false;
  @Input() size: number = 20;
  @Input() filterPlaceHolder: string = 'Filtrar';
  @Input() infoText: string = 'Exibindo Todos';
  @Input() infoTextEmpty: string = 'Lista vazia';
  @Input() filterOnValues: true;
  @Input() infoTextFiltered: string = 'Filtro aplicado';
  @Input() filterTextClear: string = 'Exibir Todos';
